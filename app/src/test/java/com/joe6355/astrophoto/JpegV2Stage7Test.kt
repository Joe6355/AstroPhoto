...
import com.joe6355.astrophoto.processing.jpeg.v2.diagnostics.PreviousProcessExitKind
import com.joe6355.astrophoto.processing.jpeg.v2.diagnostics.PreviousProcessExitReader
...
import com.joe6355.astrophoto.processing.jpeg.v2.model.BandingMetrics
import com.joe6355.astrophoto.processing.jpeg.v2.model.LinearRgb
...
import com.joe6355.astrophoto.processing.jpeg.v2.model.ResultQualityMetrics
...
import com.joe6355.astrophoto.processing.jpeg.v2.quality.FileBackedSuspiciousPointClassifier
...
class JpegV2Stage7Test {
    ...
    @Test fun stage4UsesSameSuspiciousPointClassifierAsQualityGate() {
        val quality = source(
            "app/src/main/java/com/joe6355/astrophoto/processing/jpeg/v2/quality/FileBackedResultQualityAnalyzer.kt"
        )
        val processor = source(
            "app/src/main/java/com/joe6355/astrophoto/processing/jpeg/v2/postprocessing/FileBackedAdaptivePresetProcessor.kt"
        )
    ...
    @Test fun reportFallbackZipPairedDeleteAndThumbnailPreviewAreWiredInProduction() {
        val zip = source("app/src/main/java/com/joe6355/astrophoto/SessionZipExporter.kt")
        val results = source("app/src/main/java/com/joe6355/astrophoto/ProcessedResults.kt")
    ...
    @Test fun enhancedRemainsAncillaryFileBackedAndCannotChangeResultSelection() {
        ...
        val selection = source(
            "app/src/main/java/com/joe6355/astrophoto/processing/jpeg/v2/quality/ResultSelectionPolicy.kt"
        )
    ...
    @Test fun reportContainsCompleteStage7MemoryAndRecoverySchema() {
        val source = source(
            "app/src/main/java/com/joe6355/astrophoto/processing/jpeg/v2/diagnostics/ProcessingReport.kt"
        )
        listOf(
            "memorySchemaVersion",
            "runtimeMaxHeapBytes",
    ...
    @Test fun previousProcessFailureIsShownAsDismissibleExistingStyleDialog() {
        val source = source("app/src/main/java/com/joe6355/astrophoto/MainActivity.kt")
    ...
    @Test fun cleanupScopeCannotReachSessionsProcessedOutputsOrRaw() {
        val storage = source(
            "app/src/main/java/com/joe6355/astrophoto/processing/jpeg/v2/storage/TemporaryPipelineFiles.kt"
        )
