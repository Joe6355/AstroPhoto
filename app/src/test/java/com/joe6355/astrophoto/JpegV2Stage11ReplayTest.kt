...
import com.joe6355.astrophoto.processing.jpeg.v2.model.AdaptiveProcessingFeatureFlags
...
class JpegV2Stage12ReplayTest {
    @Test fun realSessionStellarCentroidReplayWhenZipIsProvided() {
        ...
        try {
            ...
            try {
                ...
                val refinedResults = linkedMapOf<String, com.joe6355.astrophoto.processing.jpeg.v2.registration.FullResolutionRefinementResult>()
                ...
                val cleanReplayPatches = fullPatches.filter {
                    it.motionCluster == com.joe6355.astrophoto.processing.jpeg.v2.registration.TemporalMotionCluster.COHERENT_MOVING_SKY
                }
    ...
    private fun writeBackgroundDiagnosticReplay(
        ...
        registrations: Map<String, com.joe6355.astrophoto.processing.jpeg.v2.model.RegistrationResult>,
        ...
        val stars = fullResolutionStars.map { patch ->
            com.joe6355.astrophoto.processing.jpeg.v2.model.DetectedStar(
                patch.x,
                patch.y,
                1f,
                patch.localContrast,
    ...
    private fun verifyProductionEnhancedRuntime(
        ...
        var candidateImage: com.joe6355.astrophoto.processing.jpeg.v2.storage.FileBackedImage? = null
        try {
    ...
    private data class ReplayAnalysis(
        ...
        val analysis: com.joe6355.astrophoto.processing.jpeg.v2.model.FrameAnalysis,
