...
import com.joe6355.astrophoto.processing.jpeg.v2.diagnostics.PublishedArtifactVerifier
...
import com.joe6355.astrophoto.processing.jpeg.v2.diagnostics.classifyPreviousRun
import com.joe6355.astrophoto.processing.jpeg.v2.diagnostics.completeJournalWithSingleRetry
import com.joe6355.astrophoto.processing.jpeg.v2.diagnostics.publishedReportIdentityMatches
import java.io.File
...
class JpegPostCompletionHotfixTest {
    ...
    @Test fun productionOrderCompletesJournalBeforeUiAndHasSafeBoundaryFinally() {
        ...
        val browser = source("app/src/main/java/com/joe6355/astrophoto/SessionBrowser.kt")
