...
import com.joe6355.astrophoto.processing.jpeg.v2.registration.FullResolutionRefinementPolicy
...
import com.joe6355.astrophoto.processing.jpeg.v2.registration.FullResolutionStarPatchMatcher
import com.joe6355.astrophoto.processing.jpeg.v2.registration.FullResolutionTransformEvidence
import com.joe6355.astrophoto.processing.jpeg.v2.registration.SubpixelPeakEstimator
...
class JpegV2Stage11Test {
    ...
    @Test fun finalQualityGateConstantsAndCanonicalTransformRemainUnchanged() {
        ...
        val source = Files.readString(
            Path.of("src/main/java/com/joe6355/astrophoto/processing/jpeg/v2/quality/ReferenceStarRetentionValidator.kt")
        )
