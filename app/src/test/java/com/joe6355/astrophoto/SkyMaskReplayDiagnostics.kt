...
import com.joe6355.astrophoto.processing.jpeg.v2.postprocessing.AdaptiveAsinhStretch
import com.joe6355.astrophoto.processing.jpeg.v2.postprocessing.AdaptiveGradientRemoval
...
import com.joe6355.astrophoto.processing.jpeg.v2.postprocessing.BackgroundNeutralizer
import com.joe6355.astrophoto.processing.jpeg.v2.postprocessing.ChromaNoiseReducer
import com.joe6355.astrophoto.processing.jpeg.v2.postprocessing.LocalStarContrastEnhancer
import com.joe6355.astrophoto.processing.jpeg.v2.postprocessing.SkyBackgroundToneMatcher
    ...
    suspend fun analyze(fixture: Stage6RegressionFixture): SkyMaskReplayBundle {
        ...
        val starPreserved = ReferenceStarSignalPreserver().preserve(
            ...
            sensorDefectAffectedOutput =
                com.joe6355.astrophoto.processing.jpeg.v2.composition.AlphaMaskPixelSource(affected)
        ).image
...
internal class ReplayAdaptiveSkyProcessor {
    ...
    private fun finalSafetyScale(
        before: com.joe6355.astrophoto.processing.jpeg.v2.model.SkyStatisticsResult,
        after: com.joe6355.astrophoto.processing.jpeg.v2.model.SkyStatisticsResult,
        ...
        val allowedMedian = maxOf(
            com.joe6355.astrophoto.processing.jpeg.v2.color.SrgbTransfer.srgbToLinear(
